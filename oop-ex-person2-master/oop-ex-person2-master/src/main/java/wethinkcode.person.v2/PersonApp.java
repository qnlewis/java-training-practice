...
public class PersonApp{
    ...
    private static void printPerson(Person famousDirector) {
        System.out.println("Person: " + famousDirector.name());
        System.out.println("Date of birth: " + famousDirector.birthDate());
        System.out.println();
    }
}
